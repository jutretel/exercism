defmodule RomanNumeralsTest do
  ...
  test "4999" do
    assert RomanNumerals.numeral(4999) == "MMMMCMXCIX"
  end

  test "-15" do
    assert RomanNumerals.numeral(-15) == "Negative numbers are not allowed"
  end

  test "5000" do
    assert RomanNumerals.numeral(5000) == "Numbers bigger than 4999 are not allowed"
  end
end
